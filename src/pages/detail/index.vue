<template>
  <div class="detail">
    ...
    <div class="XQ">
      ...
      <h3>{{ product.name }}</h3>
      <p>
        数量<span @click="minus">-</span
        ><input type="number" v-model="num" class="num" /><span @click="add"
          >+</span
        >
      </p>
    </div>
    ...
    >
      <img
        src="https://img1.baidu.com/it/u=1877336880,817127914&fm=26&fmt=auto&gp=0.jpg"
      />
    </van-dialog>
    <van-dialog v-model="zhu" title="点击企鹅开始与我互动吧" show-cancel-button>
      <a
        target="_blank"
        href="http://wpa.qq.com/msgrd?v=3&uin=784737894&site=qq&menu=yes"
        ><img
          border="0"
          src="http://wpa.qq.com/pa?p=2:784737894:52"
          alt="请问有什么需要帮助的吗"
          title="请问有什么需要帮助的吗"
      /></a>
    </van-dialog>
